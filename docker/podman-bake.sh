...
LABEL_ARGS=(
    ...
    --label org.opencontainers.image.documentation="https://github.com/mcasillas-ctfc/ctfc-vaultwarden/wiki"
    --label org.opencontainers.image.url="https://github.com/mcasillas-ctfc/ctfc-vaultwarden"
