...
| CONTAINER_REGISTRIES  | vaultwarden/server | Comma separated value of container registries. Like `ghcr.io/mcasillas-ctfc/ctfc-vaultwarden,docker.io/vaultwarden/server` |
