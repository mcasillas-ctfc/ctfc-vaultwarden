...
fn launch_info() {
    ...
    println!(
        ...
        |   https://github.com/mcasillas-ctfc/ctfc-vaultwarden/discussions or        |\n\
        |   https://vaultwarden.discourse.group/                             |\n\
        | Report suspected bugs/issues in the software itself at:            |\n\
        |   https://github.com/mcasillas-ctfc/ctfc-vaultwarden/issues/new            |\n\
        \\--------------------------------------------------------------------/\n"
    );
}
...
fn check_web_vault() {
    ...
    if !index_path.exists() {
        ...
        error!("https://github.com/mcasillas-ctfc/ctfc-vaultwarden/wiki/Building-binary#install-the-web-vault");
