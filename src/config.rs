...
make_config! {
    ...
    sso {
        ...
        /// Client cache for discovery endpoint. |> Duration in seconds (0 or less to disable). More details: https://github.com/mcasillas-ctfc/ctfc-vaultwarden/wiki/Enabling-SSO-support-using-OpenId-Connect#client-cache
    ...
    if !cfg.disable_admin_token {
        match cfg.admin_token.as_ref() {
            ...
            Some(_) => {
                ...
                See: https://github.com/mcasillas-ctfc/ctfc-vaultwarden/wiki/Enabling-admin-page#secure-the-admin_token\n"
                );
            }
            _ => {}
        }
